...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	BOOL	rtn = m_split.CreateStatic( this, 1, 2 );
	rtn |= m_split.CreateView( 0, 0, RUNTIME_CLASS(CImgBasicView),  CSize(500,700), pContext );
	rtn |= m_split.CreateView( 0, 1, RUNTIME_CLASS(CImgBasicView2), CSize(500,700), pContext );
	return rtn;
