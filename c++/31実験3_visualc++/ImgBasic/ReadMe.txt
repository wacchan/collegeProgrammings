================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: ImgBasic プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した ImgBasic には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには ImgBasic アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
ImgBasic.h
   ...
   CImgBasicApp アプリケーション クラスを宣言します。

ImgBasic.cpp
   これは、アプリケーション クラス CImgBasicApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\ImgBasic.ico
   ...
   アイコンはメイン リソース ファイル ImgBasic.rc に含まれていま
   す。
...
ImgBasicDoc.h, ImgBasicDoc.cpp - ドキュメント
   これらのファイルは CImgBasicDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CImgBasicDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

ImgBasicView.h, ImgBasicView.cpp - ドキュメントのビュー
   これらのファイルは CImgBasicView クラスを含みます。
   CImgBasicView オブジェクトは CImgBasicDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   ImgBasic.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
