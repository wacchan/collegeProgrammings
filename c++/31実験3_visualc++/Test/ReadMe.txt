================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Test プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Test には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Test アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Test.h
   ...
   CTestApp アプリケーション クラスを宣言します。

Test.cpp
   これは、アプリケーション クラス CTestApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Test.ico
   ...
   アイコンはメイン リソース ファイル Test.rc に含まれていま
   す。
...
TestDoc.h, TestDoc.cpp - ドキュメント
   これらのファイルは CTestDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CTestDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

TestView.h, TestView.cpp - ドキュメントのビュー
   これらのファイルは CTestView クラスを含みます。
   CTestView オブジェクトは CTestDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Test.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
