...
public class SmtpClient_kadai2 {
	...
	static final String subjectText = "漢字【課題2】"; // 件名（Subject）課題3で変更
	...
	public static void sendHeader() throws IOException {
		...
		// ヘッダーSubject
		String encoded = Base64.getEncoder().encodeToString(subjectText.getBytes("ISO2022JP")); // JISに変換して符号化
		dataString = "Subject: " + "=?iso-2022-jp?B?" + encoded + "?="; 
		writeSomething(dataString);
		System.out.println("　　　　　  - " + dataString);
	}
